YUI.add("inputex-examples",function(Y){
        var html_entity_decode = function (text) {// Decode html entities
        ...
        Y.on("domready",function() {
             Y.inputEx.examples = [];
             var examples = Y.inputEx.examples;
             Y.all('.JScript').each(function(n){ examples.push(n);},this);
             ...
             for(i = 0, length = examples.length ; i < length ; i += 1) {
                                          ...
                                          try {
                                              ...
                                              code = html_entity_decode(textarea.get("innerHTML"));
                                              ...
                                              if(console) {
                                                  console.log("Error while executing example "+(i+1), ex,ex.stack);
                                              }
                                          }
                                      }
    ...
    requires : ["inputex","event","dpSyntaxHighLighter"]
});