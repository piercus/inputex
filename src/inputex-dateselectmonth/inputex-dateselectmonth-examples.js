gI.addExamples("inputex-dateselectmonth", {
              keyObject: "",list:[{
		title:"Basic DateSelectMonthField creation",
		description:"Use the following code to create a basic inputEx DateSelectMonthField.",
		fn:function(parentEl,I){
			var f = new I.DateSelectMonthField({label: 'Birthday', parentEl: parentEl, showMsg: true, required:true});
