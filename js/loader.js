               ...
               inputex: {
                   ...
                   modules:  { // one or more external modules that can be loaded along side of YUI
                				   ...
                				   'inputex': {
                					...
                					'inputex-field': {
                						path: 'js/Field.js',
                						requires: ["inputex","event-custom","oop","node"]
                					},
                					'inputex-visus': {
                					  	path: 'js/Visus.js',
                						requires: ['inputex']
                					...
                					//examples
                					"inputex-examples": {
                					    path: 'examples/inputex-examples.js',
                					    requires:["inputex","node-base","dpSyntaxHighLighter"]
                					},
                					"dpSyntaxHighLighter":{
                                        path: "examples/js/dpSyntaxHighLighter.js"
                                    },
                					// RPC
                					'inputex-rpc': {
                						path: 'js/rpc/inputex-rpc.js',
                						requires: ["inputex","io-base","jsonp" ,"json",'inputex-jsonschema']
                					},
                					'inputex-smdtester': {
                					...
                					'inputex-conditionfield': {
                					    path: 'js/mixins/conditionField.js',
                					    requires: ['inputex-hidden']
                					}
                   }
               }
           }
